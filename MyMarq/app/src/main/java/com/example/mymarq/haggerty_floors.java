...
public class haggerty_floors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haggerty_floors);
        ...
        switch (floornum){   //tests which floor to send user to
            case "Floor 1": image = findViewById(R.id.hh1); break;
            case "Floor 2": image = findViewById(R.id.hh2); break;
            case "Floor 3": image = findViewById(R.id.hh3); break;
            case "Floor 4": image = findViewById(R.id.hh4); break;
            case "Lower Level": image = findViewById(R.id.hhb); break;
