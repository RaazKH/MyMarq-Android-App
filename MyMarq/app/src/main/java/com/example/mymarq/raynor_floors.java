...
public class raynor_floors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raynor_floors);
        ...
        switch (floornum){   //tests which floor to send user to
            case "Floor 1": image = findViewById(R.id.rl1); break;
            case "Floor 2": image = findViewById(R.id.rl2); break;
            case "Floor 3": image = findViewById(R.id.rl3); break;
            case "Lower Level": image = findViewById(R.id.rlb); break;
