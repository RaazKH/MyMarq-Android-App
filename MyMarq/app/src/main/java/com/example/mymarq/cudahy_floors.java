...
public class cudahy_floors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cudahy_floors);
        ...
        switch (floornum){   //tests which floor to send user to
            case "Floor 1": image = findViewById(R.id.ch1); break;
            case "Floor 2": image = findViewById(R.id.ch2); break;
            case "Floor 3": image = findViewById(R.id.ch3); break;
            case "Floor 4": image = findViewById(R.id.ch4); break;
            case "Lower Level": image = findViewById(R.id.chb); break;
