...
public class marquette_floors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marquette_floors);
        ...
        switch (floornum){   //tests which floor to send user to
            case "Floor 1": image = findViewById(R.id.mh1); break;
            case "Floor 2": image = findViewById(R.id.mh2); break;
            case "Floor 3": image = findViewById(R.id.mh3); break;
            case "Floor 4": image = findViewById(R.id.mh4); break;
            case "Floor 5": image = findViewById(R.id.mh5); break;
            case "Lower Level": image = findViewById(R.id.mhb); break;
