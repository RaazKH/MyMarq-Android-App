...
public class amu_floors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amu_floors);
        ...
        switch (floornum){   //tests which floor to send user to
            case "Floor 1": image = findViewById(R.id.amu1); break;
            case "Floor 2": image = findViewById(R.id.amu2); break;
            case "Floor 3": image = findViewById(R.id.amu3); break;
            case "Floor 4": image = findViewById(R.id.amu4); break;
            case "Floor 5": image = findViewById(R.id.amu5); break;
